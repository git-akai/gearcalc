...
An eccentric gear is built tooth by tooth from `Gear`s, and `Gear::new` takes
...
`Eccentric::mean` kept the raw dedendum while the teeth were rebuilt deeper.
